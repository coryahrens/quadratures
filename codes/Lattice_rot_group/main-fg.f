...
c       
	 ...
	 integer s, t, npnts, ios, ipointer(100), iflag, icount
	 
	 character *50 fname3D, fname2D
c
...
c
     ...
     2                      ilhs,ilower,t2,t1,tfc,x,y,z,ipointer,iflag,
     3                      icount)
...
cc             ngen = icount
     ...
     1               iostat=ios, form = 'formatted')
	         ...
	         write(3,1000) x(ipointer(i)), y(ipointer(i)) 
...
c
	       ...
	       call bctoxyz(bccoord,lobccoord,rhbccoord,
     1                      lhbccoord,iqtype,ipnts,irhs,
     2                       ilhs,ilower,v1,v3,fc,x,y,z,ipointer,iflag,
     3                       icount)	       
...
c
	         rnorm = (x(ipointer(i))*x(ipointer(i)) + 
     1                         y(ipointer(i))*y(ipointer(i)) + 
     2                         z(ipointer(i))*z(ipointer(i)))**0.5d0
     
	         write(3,1000) x(ipointer(i))/rnorm,
     1    		                -y(ipointer(i))/rnorm, 
     2                                  z(ipointer(i))/rnorm 
